...
namespace E_Library.Models.Migrations
{
    ...
    [Migration("20220614132435_init5")]
    partial class init5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Library.Models.Roles", b =>
                {
            ...
            modelBuilder.Entity("E_Library.Models.UserRoles", b =>
                {
            ...
            modelBuilder.Entity("E_Library.Models.Users", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Library.Models.Questions", b =>
                {
                    b.HasOne("E_Library.Models.Exam", "Exams")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("E_Library.Models.UserRoles", b =>
                {
                    b.HasOne("E_Library.Models.Roles", "Roles")
                        .WithMany("UserRoles")
                        .HasForeignKey("RolesRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Library.Models.Users", "Users")
                        .WithMany("UserRoles")
